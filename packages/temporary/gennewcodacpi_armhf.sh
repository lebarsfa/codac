...
# wget https://github.com/lebarsfa/ibex-lib/releases/download/ibex-2.8.9.20260215/ibex_armhf_\$(lsb_release -cs).zip --no-check-certificate -nv is causing illegal instruction on a Mac M1... \\
curl -L -O https://github.com/lebarsfa/ibex-lib/releases/download/ibex-2.8.9.20260215/ibex_armhf_\$(lsb_release -cs).zip --insecure && \
